...
export async function submitSimpleRSVP(data: SimpleRSVPData): Promise<SimpleRSVPResult> {
  try {
    ...
    console.log('🎭 Fetching main wedding event...');
    ...
    console.log('✅ Found main event:', mainEvent);
    ...
    if (existingRSVP) {
      console.log('📝 Updating existing RSVP...', rsvpData);
    ...
    console.log('✅ Simple RSVP saved successfully:', rsvpResult.data);

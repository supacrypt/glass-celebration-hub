...
interface EnhancedPhotoModerationProps {
  photos: EnhancedPhoto[];
  onRefresh: () => void;
}

const EnhancedPhotoModeration: React.FC<EnhancedPhotoModerationProps> = ({ photos, onRefresh }) => {
  ...
  const setupRealTimeUpdates = () => {
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('Real-time photo update:', payload);
...
export default EnhancedPhotoModeration;
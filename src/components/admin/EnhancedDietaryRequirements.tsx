...
interface EnhancedDietaryRequirementsProps {
  rsvpId: string;
  isEditable?: boolean;
  onUpdate?: () => void;
}

const EnhancedDietaryRequirements: React.FC<EnhancedDietaryRequirementsProps> = ({ 
  rsvpId, 
  isEditable = false,
  onUpdate 
}) => {
...
export default EnhancedDietaryRequirements;